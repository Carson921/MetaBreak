...
Folder `moderator/` contains the Python code designed for the experiments outlined in **Section 5.3** of our research paper. These experiments were focused on evaluating the **flagging rates** of different prompts and calculating **replacement tokens** to evade safety mechanisms in language models.
